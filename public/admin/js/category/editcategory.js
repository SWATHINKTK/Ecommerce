...
function editCategoryImageConfigurations(){


    const editCategoryImageChange = document.getElementById('edit-categoryImage');
    if(editCategoryImageChange){

        editCategoryImageChange.addEventListener('change',(event)=>{
...
function editCategoryFormSubmit(){
    ...
    const categoryEditFormSubmit = document.getElementById('editCategoryForm'); 
    if(categoryEditFormSubmit){
